...
import { Loader2, CalendarCheck, Inbox, UserCircle, Clock, CheckCircle, XCircle, Image as ImageIcon } from 'lucide-react';
  ...
  return (
    ...
    {imageToPreview && (
      <ImagePreviewDialog open={!!imageToPreview} onOpenChange={() => setImageToPreview(null)}>
        <ImagePreviewDialogContent className="max-w-3xl p-2 glass-effect">
