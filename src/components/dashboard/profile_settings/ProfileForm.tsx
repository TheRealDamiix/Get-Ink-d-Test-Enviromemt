...
import type { ProfileFormData, AuthUser } from '@/types';
...
const ProfileForm = ({
  ...
  const onInputChange = <K extends keyof ProfileFormData>(field: K, value: ProfileFormData[K]) => {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
        <div className="flex flex-col items-center space-y-4">
          ...
          <Input
            ...
            className="hidden"
          />
          <Button type="button" variant="outline" onClick={() => (document.getElementById('profilePhoto') as HTMLInputElement | null)?.click()} disabled={isUploading || isSaving}>
        ...
        {displayIsArtist && (
          <div className="flex flex-col items-center space-y-4">
            ...
            <Input
              ...
              className="hidden"
            />
            <Button type="button" variant="outline" onClick={() => (document.getElementById('locationThumbnail') as HTMLInputElement | null)?.click()} disabled={isUploading || isSaving}>
