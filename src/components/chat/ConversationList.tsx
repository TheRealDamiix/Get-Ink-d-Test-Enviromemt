...
interface ConversationWithOtherUser extends Conversation {
  otherUser?: Pick<Profile, 'id' | 'name' | 'username' | 'profile_photo_url' | 'is_artist'>;
  last_message_content?: string | null;
  unread_count?: number;
}

interface ConversationListItemProps {
  conv: ConversationWithOtherUser;
  onSelectConversation: (id: string) => void;
  selectedConversationId: string | null;
}

const ConversationListItem: React.FC<ConversationListItemProps> = ({ conv, onSelectConversation, selectedConversationId }) => {
...
const ConversationList: React.FC<ConversationListProps> = ({ conversations, onSelectConversation, selectedConversationId, isLoading }) => {
  if (isLoading) {
    return (
