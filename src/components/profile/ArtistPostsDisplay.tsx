...
interface ArtistPostsDisplayProps {
  artistId: string;
  artistUsername: string;
  artistName: string | null;
  artistProfilePhotoUrl: string | null;
}

const ArtistPostsDisplay = ({ artistId, artistUsername, artistName, artistProfilePhotoUrl }: ArtistPostsDisplayProps) => {
          ...
          >
            <div className="flex items-center mb-3">
              <Avatar className="w-9 h-9 mr-2.5 border border-primary/30">
                <AvatarImage src={artistProfilePhotoUrl ?? undefined} alt={artistName ?? undefined} />
