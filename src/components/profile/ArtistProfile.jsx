...
const ArtistProfile = () => {
  ...
  const fetchArtistData = useCallback(async () => {
    ...
    try {
      ...
      console.error('General error in fetchArtistData:', generalError);
      toast({ title: "Error loading artist profile", description: generalError.message, variant: "destructive" });
      setArtist(null); // Ensure artist is null on error to show "Artist not found"
    } finally {
      setLoading(false);
    }
  }, [username, user]);
