            ...
            <div className="flex-1 text-center md:text-left">
              ...
              {artist.location && (
                <p className="text-sm text-muted-foreground flex items-center justify-center md:justify-start mb-1">
                  <MapPin className="w-4 h-4 mr-1.5 text-primary/80" /> {artist.location}
                </p>
              )}
              {artist.studio_name && (
            ...
            {artist.booking_link && isValidUrl(artist.booking_link) ? (
              <Button variant="outline" size="sm" asChild>
                <a href={artist.booking_link} target="_blank" rel="noopener noreferrer">
                  <ExternalLink className="w-4 h-4 mr-2" /> Booking Info
                </a>
              </Button>
            ) : artist.booking_link ? (
                 <Button variant="outline" size="sm" disabled>
                  <ExternalLink className="w-4 h-4 mr-2" /> Invalid Booking Link
                </Button>
            ) : null}
          </div>
        </div>
