...
interface AllArtistReviewsDialogProps {
...
const AllArtistReviewsDialog = ({ artistProfile, allReviews, open, onOpenChange }: AllArtistReviewsDialogProps) => {
  const artistName = (artistProfile as Record<string, unknown>)?.name as string | undefined
