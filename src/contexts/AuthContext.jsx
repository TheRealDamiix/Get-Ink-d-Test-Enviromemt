    ...
    try {
      ...
      if (dbProfile) {
        ...
        if (typeof rawMeta.is_artist === 'boolean') {
         ...
         // No profileError, no dbProfile, but sessionUser exists. Possible if profile creation is delayed.
        if (typeof rawMeta.is_artist === 'boolean') {
          determinedIsArtist = rawMeta.is_artist;
        }
         profileDataForUserObject = {
      ...
      return fullUser;
        ...
        setProfileLoading(false);
        return { ...sessionUser, is_artist: false, profile: null }; // Return a basic user object
    }
  }, []);
